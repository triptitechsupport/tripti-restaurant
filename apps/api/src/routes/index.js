...
import fiscalizationRouter from './fiscalization.js';
...
export default () => {
	...
	// Fiskaly SIGN AT fiscalization (POST-End-Order; admin-operated).
	router.use('/fiscalization', authMiddleware, fiscalizationRouter);
